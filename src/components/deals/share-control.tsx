...
import { quickShareDealAction } from "@/server/quick-actions";
...
export function ShareControl({
  ...
  async function toggle(userId: string, on: boolean) {
    ...
    const res = await quickShareDealAction(dealId, userId, on);
    if (res.error) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Share deal access</DialogTitle>
          <DialogDescription>Grant individual sales users access to this deal.</DialogDescription>
        </DialogHeader>
